...
<html>
    <head>
        ...
        <title><g:message code="inventoryAdjustment.edit" default="Edit Inventory Adjustment" /></title>
    ...
    <body>
        ...
        <div class="body">
            <h1><g:message code="inventoryAdjustment.edit" default="Edit Inventory Adjustment" /></h1>
            ...
            <g:form action="save" method="post" >
                <div class="dialog">
                    <table>
                        <tbody>
                        	<g:hiddenField class="warehouse" id="warehouseId" name="inventoryAdjustmentInstance.warehouse.id" value="${inventoryAdjustmentInstance.warehouse.id}" />
                        	<g:hiddenField class="itemType" id="itemTypeId" name="inventoryAdjustmentInstance.itemType.id" value="${inventoryAdjustmentInstance.itemType.id}" />
                        	
                            <tr class="prop">
                                <td valign="top" class="name">
                                	<label for="name"><g:message code="inventoryAdjustment.warehouse.label" default="Warehouse" /></label>
                                </td>
                                <td valign="top" class="value">
                                	${fieldValue(bean: inventoryAdjustmentInstance, field: "warehouse.identifier")}
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value">
                                	${fieldValue(bean: inventoryAdjustmentInstance, field: "itemType.identifier")}
                                </td>
                            </tr>
