  ...
  <div class="body">
    ...
    <g:form method="post" enctype="multipart/form-data">
      ...
      <div class="dialog">
        <table>
          <tbody>
            <g:if test="${params?.changePicture}">
            <tr class="prop">
            ...
            <tr class="prop">
              ...
              <td valign="top" class="value ${hasErrors(bean: productInstance, field: 'photo', 'errors')}">
                <g:link action="edit" id="${productInstance?.id}" params="${[changePicture:true]}">Change Picture</g:link>
              </td>
            </tr>
			...
			<tr class="prop">
			 <td valign="top" class="name">
			   <label for="warehouse"><g:message code="product.warehouse.label" default="Item Location" /></label>
			 </td>
			</tr>
			...
			<tr class="prop">
			  <td valign="top" class="name">
			    <label for="warehouse"><g:message code="product.warehouse.label" default="${warehouse?.itemLocationWarehouse?.description}" /></label>
			  </td>
			  <td valign="top" class="value ${hasErrors(bean: productInstance, field: 'itemLocation', 'errors')}">
				<g:select class="itemLocation" name="itemLocation" from="${warehouse?.itemLocationWarehouse?.itemLocations.sort{it.toString()}}" value="${warehouse?.selectedItemLocation?.id}" optionKey="id" noSelection="['no selection': '']" />
			  </td>
			</tr>
			</g:each>
           	</g:if>
