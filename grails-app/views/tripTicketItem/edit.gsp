...
<body>
  ...
  <div class="body">
    ...
    <g:form method="post" >
      ...
      <g:hiddenField name="version" value="${tripTicketItemInstance?.version}" />
      <div class="dialog">
        <table>
          <tbody>
          ...
          <g:link action="show" controller="tripTicket" id="${tripTicketItemInstance?.tripTicket?.id}">${tripTicketItemInstance?.tripTicket}</g:link>
          </td>
          </tr>
