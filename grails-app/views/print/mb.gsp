    ...
    <table class="main">
    	...
    	<tr>
		    ...
		    <div id="footer">
		      <table>
		        <tr class="prop">
		          <td colspan="2" class="total">${bean.checks.size()}</td>
		        </tr>
		        <tr class="prop">
		          <td colspan="2" class="total">${bean.formatTotal()}</td>
		        </tr>
		        <tr class="prop">
		          <td class="total1">${formatDate(date:bean?.depositDate, format:"MMM. dd, yyyy")}</td>
		          <td class="total2"></td>
		        </tr>
		      </table>
		    </div>
