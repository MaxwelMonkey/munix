    ...
    <table class="main">
    	<tr>
    		...
    		<div id="transaction-date">
    			${formatDate(date:bean?.depositDate, format:"MMM. dd, yyyy")}
    		</div>
		    <div id="head">
		      <table>
		        <tr class="prop">
		          <td class="value col1"><div id="accountNumber">${bean.account?.accountNumber?.substring(0,3)} ${bean.account?.accountNumber?.substring(3,5)} ${bean.account?.accountNumber?.substring(5,10)} ${bean.account?.accountNumber?.substring(10)} ${bean}</div></td>
		        </tr>
		        <tr class="prop">
		          <td class="value"><div id="accountName">${bean.account?.accountName}</div></td>
		        </tr>
		        <tr class="prop">
		          <td class="value"><div id="totalAmount"></div></td>
		        </tr>
		      </table>
		    </div>
		  	</td>
