                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: directPaymentInvoiceInstance, field: 'type', 'errors')}">
                                    <g:textField name="type" value="${directPaymentInvoiceInstance?.type}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: directPaymentInvoiceInstance, field: 'directPayment', 'errors')}">
                                    <g:select name="directPayment.id" from="${com.munix.DirectPayment.list()}" optionKey="id" value="${directPaymentInvoiceInstance?.directPayment?.id}"  />
                                </td>
                            </tr>
