...
<body>
  ...
  <div class="body">
    ...
    <g:form method="post" >
      ...
      <g:hiddenField name="version" value="${checkDepositInstance?.version}" />
      <div class="dialog">
        <table>
          <tbody>
          <tr class="prop">
      ...
      <table>
        <thead>
          <tr>
          	<th class="center"><g:checkBox name="selectAll" checked= "false"  onClick="checkFields(document.getElementsByName('checkBoxes'), this)"/></th>
            <th>Check Number</th>
            <th>Check Date</th>
            <th>Customer</th>
            <th>Bank - Branch</th>
        ...
        <tbody class="checkTable">
            <g:each in="${checkPayments}" var="i">
              <tr>
                ...
                <g:if test="${checkDepositInstance.checks.contains(i)}">
                    <g:set var="checked" value="${true}"/>
                </g:if>
                <td class="center"><g:checkBox name="checkBoxes" value="${i.id}" checked="${checked}"/></td>
