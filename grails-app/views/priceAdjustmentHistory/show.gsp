<html>
    <head>
        ...
        <title><g:message code="priceAdjustmentHistory.show" default="Price Adjustment History" /></title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            <h1><g:message code="priceAdjustmentHistory.show" default="Price Adjustment History" /></h1>
            ...
            <g:form>
                <g:set var="prod" value="${priceAdjustmentHistoryInstance?.product}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            <tr class="prop">
