    ...
    <g:form action="save" method="post" >
      <div class="dialog">
        <table>
          ...
          <g:select name="type.id" from="${com.munix.CustomerType.list().sort{it.toString()}}" optionKey="id" value="${customerInstance?.type?.id}" optionValue="description" noSelection="['null': '']" />
          </td>
          </tr>
