...
class CreditMemoItemController {
    ...
    def create = {
        ...
        def salesDeliveryList = salesDeliveryService.listOfSalesDeliveryForCreditMemo(creditMemoInstance.customer,creditMemoInstance.discountType)
    ...
    def save = {
        ...
        if(creditMemoItemInstance?.creditMemo){
            salesDeliveryList = salesDeliveryService.listOfSalesDeliveryForCreditMemo(creditMemoItemInstance?.creditMemo?.customer,creditMemoItemInstance?.creditMemo?.discountType)
        }
        else{
    ...
    def edit = {
        ...
        if (creditMemoItemInstance) {
            if(creditMemoService.checkIfCreditMemoExistForProduct(creditMemoItemInstance.deliveryItem, creditMemoItemInstance.date)){
                ...
                def salesDeliveryList = salesDeliveryService.listOfSalesDeliveryForCreditMemo(creditMemoItemInstance.creditMemo.customer,creditMemoItemInstance.creditMemo.discountType)
